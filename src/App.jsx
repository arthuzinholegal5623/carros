    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <p className="font-lexend mb-7">Escolha um sedan pelo seu preço acessível e excelente economia de combustível. Ideal para dirigir na sua cidade ou na siua próxima viagem</p>
        ...
        <div className="bg-green p-12">
          ...
          <p className="font-lexend mb-7">Escolha um SUV pelo o seu interior espaçoso, poder e versatilidade. PErfeito para passar as férias em família ou para aventuras off-road</p>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <p className="font-lexend mb-7">Passeie nos melhores carros sem os preços exorbitantes. Desfrute de um conforto aprimorado de um aluguel de luxo e cheque com estilo</p>
